...
================================
-run_Thermoneutralizer.sh (shell script for temporarily setting environment variables and 
 executing the application)
   -to run the shell script, type
   
       ./run_Thermoneutralizer.sh <mcr_directory> <argument_list>
    ...
    /mathworks/home/application/v83, run the shell script as:
       ...
       ./run_Thermoneutralizer.sh /mathworks/home/application/v83
       
    If you have MATLAB installed in /mathworks/devel/application/matlab, 
    run the shell script as:
    
       ./run_Thermoneutralizer.sh /mathworks/devel/application/matlab
-MCRInstaller.zip 
   -if end users are unable to download the MCR using the above  
    link, include it when building your component by clicking 
    the "Add MCR" link in the Deployment Tool
-The Macintosh bundle directory structure Thermoneutralizer.app 
   -this can be gathered up using the zip command 
    zip -r Thermoneutralizer.zip Thermoneutralizer.app
    or the tar command 
    tar -cvf Thermoneutralizer.tar Thermoneutralizer.app
-This readme file 
...
A. Mac systems:
   ...
   the MATLAB Compiler documentation in the MathWorks Documentation Center.
        ...
        NOTE: When deploying standalone applications, it is possible 
              to run the shell script file run_Thermoneutralizer.sh 
